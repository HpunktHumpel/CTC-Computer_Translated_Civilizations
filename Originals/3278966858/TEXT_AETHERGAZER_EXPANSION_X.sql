...
('LOC_CIVILIZATION_AETHERGAZER_GREY_LULIANG_NAME','zh_Hans_CN','天垣神域--百解'),
...
('LOC_TRAIT_LEADER_LULIANG_AETHERGAZER_DESCRIPTION','zh_Hans_CN','创建首都后立即获得禄良、英招、开拓者（电脑玩家无法获得）、2个商人以及2条[ICON_TradeRoute]贸易路线容量。游戏初始便解锁“{LOC_TECH_CELESTIAL_NAVIGATION_NAME}”科技，所有您创建或攻占的城市一开始便拥有贸易站，创建贸易路线后，目的地城市中将立即出现贸易站。[ICON_TradeRoute]贸易路线-50%[ICON_Faith]信仰产出。所有城市的区域为[ICON_TradeRoute]贸易路线+1[ICON_Faith]信仰+5[ICON_Gold]金币'),
