...
('LOC_UNIT_ARMORRANGED_MODIFIER_LV1_RELOAD_DESCRIPTION','zh_Hans_CN','特殊的远程单位，仅有部分修正者领袖能够建造，能够轻松抵御近战单位和远程单位的攻击。随着科技的升级，射程也比普通的远程修正者更远[NEWLINE]研究{LOC_TECH_IRON_WORKING_NAME}、{LOC_TECH_APPRENTICESHIP_NAME}、{LOC_TECH_GUNPOWDER_NAME}、{LOC_TECH_MILITARY_SCIENCE_NAME}和{LOC_TECH_REPLACEABLE_PARTS_NAME}能使单位[ICON_Strength]战斗力提升[NEWLINE]研究{LOC_TECH_FLIGHT_NAME}、{LOC_TECH_COMPUTERS_NAME}能使单位[ICON_Range]射程提升[NEWLINE]+高近战战斗力[NEWLINE]+擅长对抗近战单位[NEWLINE]+擅长对抗远程单位[NEWLINE]-移动力较低[NEWLINE]-会受反骑兵单位克制[NEWLINE]-会受骑兵单位克制'),
('LOC_UNIT_ARMORRANGED_MODIFIER_LV2_RELOAD_NAME','zh_Hans_CN','精锐装甲远程修正者'),
('LOC_UNIT_ARMORRANGED_MODIFIER_LV2_RELOAD_DESCRIPTION','zh_Hans_CN','特殊的远程单位，仅有部分修正者领袖能够建造，能够轻松抵御近战单位和远程单位的攻击，射程也比普通的精锐远程修正者更远[NEWLINE]+高近战战斗力[NEWLINE]+高射程[NEWLINE]+擅长对抗近战单位[NEWLINE]+擅长对抗远程单位[NEWLINE]-移动力较低[NEWLINE]-会受反骑兵单位克制[NEWLINE]-会受骑兵单位克制'),
--单位类型
...
('LOC_DISTRICT_HOLY_SITE_AETHERGAZER_TYPEONE_DESCRIPTION','zh_Hans_CN','尼罗神域特色区域，替代{LOC_DISTRICT_HOLY_SITE_NAME}，初始解锁，造价更低且不会涨价，可以无视人口需求建造，+3[ICON_Housing]住房，没有任何相邻加成且拥有十个专家槽，建成后该城市每位[ICON_Citizen]公民+2[ICON_Faith]信仰'),
('LOC_DISTRICT_INDUSTRIAL_ZONE_AETHERGAZER_NAME','zh_Hans_CN','诺伊汉萨重工'),
('LOC_DISTRICT_INDUSTRIAL_ZONE_AETHERGAZER_DESCRIPTION','zh_Hans_CN','尼罗神域特色区域，替代{LOC_DISTRICT_INDUSTRIAL_ZONE_NAME}，初始解锁，免费建造且不会涨价，可以无视人口需求建造，+3[ICON_Housing]住房，没有任何相邻加成且拥有十个专家槽，建成后该城市每位[ICON_Citizen]公民+2[ICON_Production]生产力'),
